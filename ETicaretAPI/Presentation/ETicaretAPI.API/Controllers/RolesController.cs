...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class RolesController : ControllerBase
    {
        ...
        [HttpGet]
        [AuthorizeDefinition(ActionType = Application.Enums.ActionType.Reading, Definition = "Get Roles", Menu = AuthorizeDefinitionConstants.Roles)]
        ...
        [HttpGet("{Id}")]
        [AuthorizeDefinition(ActionType = Application.Enums.ActionType.Reading, Definition = "Get Role By Id", Menu = AuthorizeDefinitionConstants.Roles)]
        ...
        [HttpPost]
        [AuthorizeDefinition(ActionType = Application.Enums.ActionType.Writing, Definition = "Create Roles", Menu = AuthorizeDefinitionConstants.Roles)]
        ...
        [HttpPut("{Id}")]
        [AuthorizeDefinition(ActionType = Application.Enums.ActionType.Updating, Definition = "Update Role", Menu = AuthorizeDefinitionConstants.Roles)]
        ...
        [HttpDelete("{Id}")]
        [AuthorizeDefinition(ActionType = Application.Enums.ActionType.Deleting, Definition = "Delete Role", Menu = AuthorizeDefinitionConstants.Roles)]
